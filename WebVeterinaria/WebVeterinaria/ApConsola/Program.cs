    ...
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            while (!salirPrograma)
            {
                ...
                Console.WriteLine("5. TipoAnimal");
        ...
        static async Task MenuAnimales()
        {
            ...
            while (!salirAnimales)
            {
                ...
                Console.WriteLine("2. Buscar animal por ID");
        ...
        static async Task MenuDuenios()
        {
            ...
            while (!salirDuenios)
            {
                ...
                Console.WriteLine("2. Buscar dueño por ID");
        ...
        {
            var animales = await client.GetFromJsonAsync<List<DtoAnimal>>("animal");
