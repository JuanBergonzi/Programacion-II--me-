...
namespace WebVeterinaria.Logica.MedicamentoLogic
{
    public class MedicamentoLogic : IMedicamentoLogic
    {
        ...
        {
            Datos.Clase.Medicamento medicamento = _medicamentoRepository.ObtenerMedicamento(id);
        ...
        public bool AgregarMedicamento(DtoMedicamento nuevoMedicamento)
        {
            ...
            var medicamentoEntidad = new Datos.Clase.Medicamento
            {
        ...
        {
            List<WebVeterinaria.Datos.Clase.Medicamento> medicamentos = _medicamentoRepository.ObtenerMedicamentos();
